...
robot1 = aim.Robot("192.168.2.51")
robot2 = aim.Robot("192.168.2.53")
...
move_robot_1_thread = aim.Thread(move_in_square, args=(robot1,))
move_robot_2_thread = aim.Thread(move_in_square, args=(robot2,))
